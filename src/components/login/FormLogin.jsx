  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 h-screen w-screen">
        <div className="flex items-center justify-center bg-cover bg-center bg-no-repeat background-darkBlue ">
          <div className=" text-white w-full sm:w-[800px] h-96 rounded-lg p-4">
