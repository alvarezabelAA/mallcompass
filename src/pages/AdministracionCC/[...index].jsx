    ...
    <>
      ...
      <SideBars>
        ...
        <div className='w-full items-center md:m-2'>
                ...
                <div className="rounded bg-base-100 shadow-xl md:m-2">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-center mt-4">
                      <button onClick={()=>handleModalOpen(mall)} className="bg-emerald-600 rounded p-3 text-white font-medium mx-2">+ Tiendas</button>
          ...
          {modalVisible && (
            <Modal titulo="Agregar Tienda" onClose={handleModalClose}>
