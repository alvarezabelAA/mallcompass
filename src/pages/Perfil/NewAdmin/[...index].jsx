...
import { postToAPI, pathGen, decryptAndGetLocalStorage } from '../../../funciones/api';
...
const NewAdmin = () => {
  ...
  const handleRegistro = async ({ imageFile }) => {
    ...
    const endpoint = 'http://localhost:4044/usuario/final/registro2'; // Ajusta la URL del servidor de registro
    const endpoint2 = 'http://localhost:4044/usuario/final/rel'; // Ajusta la URL del servidor de registro
    ...
    try {
      try {
        ...
        if(response.status === 1){
          ...
          const response2 = await postToAPI(endpoint2, registroData2);
  ...
  return (
    <div className="md:p-32 md:py-24 bg-no-repeat bg-cover bg-center relative">
      ...
      <div className="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
        <div className="flex justify-center self-center  z-10">
          <div className="p-12 bg-white  mx-auto rounded-2xl w-[650px] ">
            <div className="mb-4">
              <h3 className="font-semibold text-2xl text-gray-800">Registra tu administrador </h3>
            </div>
